...
# -*- coding: utf-8 -*-
# this is from
# https://github.com/yuanxu-li/html-table-extractor/blob/master/html_table_extractor/extractor.py
# changed to reutrn raw html dom of each cell instead of text
